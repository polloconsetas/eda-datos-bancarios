...
- limpieza_final.py → Script de Python para limpiar, transformar y visualizar los datos.
- eda.ipynb → Borrador con los pasos seguidos para la limpieza y conseguir un script más depurado y efectivo.
...
* Un editor de código como **VSCode**. Y las siguientes bibliotecas:  **pip install pandas numpy matplotlib seaborn openpyxl**
...
## **📄 informe.md (Copia y guarda como informe.md)**
